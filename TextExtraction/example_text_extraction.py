...
if __name__ == '__main__':
    ...
    # List of file paths to test the extract_from_list method
    ...
    with tesserocr.PyTessBaseAPI() as api:
        ...
        # text = text_extractor.extract_from_file(pdf_John, output_path=None, print_results=True, get_data=False)
        ...
        The get_tess_auto_segments method in the ImageCropper class will use tesseract's built-in page segmentation 
        analysis methods to grab cropped images of the automatically detected text segments. Feeding these back into 
        tesseract for OCR can make sure that text is properly segmented (sometimes it needs to try on a smaller image),
        which can improve accuracy."""
        # UNCOMMENT THE LINES BELOW
        
        # # Read in the image
        # image = utils.convert_file_to_images(pdf_John)[0]
